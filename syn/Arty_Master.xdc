## This file is an intentionally minimied/simplified .xdc derived from Arty-A7 Rev B
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { dup_clk }]; #IO41
